...
(operadores e operandos). O processo de avaliacao consiste em fazer a leitura dos elementos
armazenados (tokens) na fila, substituindo-se, sempre que encontrada, uma sequencia de um operador
seguida de dois operandos pelo resultado da operacao indicada. Caso contrario, os elementos lidos
sao reinseridos na fila. O processo a repetido ata a fila conter um unico elemento que a o resultado da expressao.
